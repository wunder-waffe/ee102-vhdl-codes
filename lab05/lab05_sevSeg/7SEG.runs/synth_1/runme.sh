...
HD_PWD='C:/Users/Berke/Desktop/lab05_sevSeg/7SEG.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log segSeven.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source segSeven.tcl
