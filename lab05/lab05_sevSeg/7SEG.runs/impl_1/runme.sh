...
HD_PWD='C:/Users/Berke/Desktop/lab05_sevSeg/7SEG.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log segSeven.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source segSeven.tcl -notrace
